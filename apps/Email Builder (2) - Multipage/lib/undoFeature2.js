...
const booklineValue = booklineSelect2.value;
...
featureStartComment = '<!-- FEATURE 2 -->';
  featureEndComment = '<!-- /FEATURE 2 -->';
} else {
  throw new Error("Invalid featureSelect2 value for removing feature.");
}
