...
if ((featureSelect3.value === feature_image_left.value || featureSelect3.value === feature_image_right.value) && logoSwitch3.value === true) {
...
const booklineComment = deviceSwitch.value
  ...
  if (commentPosition !== -1) {
    ...
    return "Logo lockup 3 inserted successfully.";
  } else {
    throw new Error(`Comment '${commentToFind}' not found in the correct feature.`);
  }
} else {
  return "Conditions not met to insert logo lockup 3.";
}
