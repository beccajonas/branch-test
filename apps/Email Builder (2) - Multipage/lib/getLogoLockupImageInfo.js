...
// Get the first file from the logoLockupImage1 component
const file = logoLockupImage1.value[0];
...
img.onload = function () {
  ...
  logoLockupImgHeightState1.setValue(imgHeight);
};

// Add error handling for image loading
img.onerror = function() {
  throw new Error("Failed to load logo lockup image");
};
