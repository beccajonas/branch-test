...
// Get the first file from the featureImage3 component
const file = featureImage3.value[0];
...
img.onload = function () {
  ...
  featureImgHeightState3.setValue(imgHeight);
  featureImgWidthState3.setValue(imgWidth);
};
