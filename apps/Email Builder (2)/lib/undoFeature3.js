...
const booklineValue = booklineSelect3.value;
...
featureStartComment = '<!-- FEATURE 3 -->';
  featureEndComment = '<!-- /FEATURE 3 -->';
} else {
  throw new Error("Invalid featureSelect3 value for removing feature.");
}
