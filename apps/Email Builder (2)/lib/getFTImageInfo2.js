...
// Get the first file from the featureImage2 component
const file = featureImage2.value[0];
...
img.onload = function () {
  ...
  featureImgHeightState2.setValue(imgHeight);
  featureImgWidthState2.setValue(imgWidth);
};
